  ...
  const filter = (e) => {
    switch (e.target.id) {
      case 'northam':
        ...
        document.getElementById('northam').classList.add('selected');
        setCategories([...data.filter((c) => c.continent === 'North America')]);
        break;
      case 'southam':
        document.querySelector('.selected')?.classList.remove('selected');
        document.getElementById('southam').classList.add('selected');
        setCategories([...data.filter((c) => c.continent === 'South America')]);
        break;
      case 'europe':
        document.querySelector('.selected')?.classList.remove('selected');
        document.getElementById('europe').classList.add('selected');
        setCategories([...data.filter((c) => c.continent === 'Europe')]);
        break;
      case 'africa':
        document.querySelector('.selected')?.classList.remove('selected');
        document.getElementById('africa').classList.add('selected');
        setCategories([...data.filter((c) => c.continent === 'Africa')]);
        break;
      case 'oceania':
        document.querySelector('.selected')?.classList.remove('selected');
        document.getElementById('oceania').classList.add('selected');
        setCategories([...data.filter((c) => c.continent === 'Oceania')]);
        break;
      case 'asia':
        document.querySelector('.selected')?.classList.remove('selected');
        document.getElementById('asia').classList.add('selected');
        setCategories([...data.filter((c) => c.continent === 'Asia')]);
        break;
      case 'antarctica':
        document.querySelector('.selected')?.classList.remove('selected');
        document.getElementById('antarctica').classList.add('selected');
    ...
    return (
      <div className="main">
        <div className="header">
          ...
          <h2 className="intro">Welcome to my Covid-19 Cases tracker</h2>
          <div className="filters">
            <button type="button" className="filter-button selected" id="all" onClick={filter}>All countries</button>
